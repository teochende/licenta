...
/**
 * Securitate JWT + CORS centralizat (fără {@code @CrossOrigin} pe controllere).
 * {@code CorsFilter} din {@code http.cors(...)} rulează înainte de filtrele de autentificare,
 * astfel preflight-ul OPTIONS și răspunsurile CORS nu sunt blocate de JWT.
 */
@Configuration
@EnableWebSecurity
